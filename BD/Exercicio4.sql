...
--1️. Listar todos os alunos e os nomes das turmas em que estão matriculado
SELECT DISTINCT AL.NOME,T.ID_TURMA FROM ALUNO AL JOIN MATRICULADO MA ON AL.ID_MATRICULA = MA.FK_ALUNO 
JOIN TURMA T ON MA.FK_TURMA = T.ID_TURMA;
